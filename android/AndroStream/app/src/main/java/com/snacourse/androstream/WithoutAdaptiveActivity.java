...
public class WithoutAdaptiveActivity extends AppCompatActivity implements VideoRendererEventListener {
...
//Set media controller
        ...
        Uri mp4VideoUri = Uri.parse("http://192.168.1.9:8095/videoStream/"); //Radnom 540p indian channel
